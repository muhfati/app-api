...
class SyncPermissions extends Command
{
    ...
    protected array $ignoreMethods = [
        ...
        'BillCallBackController@__construct',
        'BillCallBackController@receive_controll_no',
        'BillCallBackController@receive_payment',
        'BillCallBackController@receive_reconciliation',
        'BillCallBackController@getXMLData',
        'BillCallBackController@getPaymentXMLData',
        'BillCallBackController@get_string_between',
        'BillCallBackController@change_app_status',
        'ZanMalipoController@getPrivateKey',
        'ZanMalipoController@getPublicKey',
        'ZanMalipoController@createSignature',
        'ZanMalipoController@verifySignature',
        'ZanMalipoController@sendRequest',
        'ZanMalipoController@reuseBillSendRequest',
        'ZanMalipoController@changeBillSendRequest',
        'UserProfileController@check_login',
        'UserProfileController@changePassword',
        'UserProfileController@resetPassword',
        'UserProfileController@auditLogs',
